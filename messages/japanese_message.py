...
async def get_jp_msg_voice(
    ...
    jp_message = {
        ...
        "mention_F": {"title": "Read Mention", "description": "これからはメンションを読み上げません!"},
        "mention_T": {"title": "Read Mention", "description": "これからはメンションを読み上げます!"},
        "readotherbot_F": {
        ...
        "afktimeout_F": {
            ...
            "description": f"これからは非活動時でも{bot_name}は自動でボイスチャットから抜けません!",
        },
        "afktimeout_T": {
            "title": "AFK Timeout Limit",
            "description": f"これからは{bot_name}が非活動時にボイスチャットから自動で抜ける時間を{input1}分{input2}秒に設定します!",
        },
        "voicedescription": {
            "title": "声の説明",
    ...
    jp_voice_iru = {
        ...
        "reademoji_F": "これからは絵文字を読み上げないよ～!",
        "reademoji_T": "これからは絵文字を読み上げるよ～!",
        ...
        "afktimeout_F": "これからは僕がボイチャから自動で抜けないよ～!",
        "afktimeout_T": f"これからは僕が{input1}分{input2}秒話さなかった時に抜けるよ～!",
        ...
        "noprivateerror": "ここはDMだよ!そのコマンドはここでは使えないよ!シランガナ!",
    ...
    jp_voice_ruka = {
        ...
        "readname_F": "こ、これからは…、メッセージの…、さ、作者さんを…、よ、読み上げません!",
        "readname_T": "こ、これからは…、メッセージの…、さ、作者さんを…、よ、読み上げます!",
        "readbot_F": "こ、これからは…、私の文章を…、よ、読み上げません!(ほ…)",
        "readbot_T": "こ、これからは…、私の文章を…、よ、読み上げます!(よ、よろしく…、お願いします!)",
        "mention_F": "こ、これからは…、メンションを…、よ、読み上げません!",
        "mention_T": "こ、これからは…、メンションを…、よ、読み上げます!",
        "readotherbot_F": "こ、これからは…、私以外の…、ボットのメッセージを…、よ、読み上げません!",
        "readotherbot_T": "こ、これからは…、私以外の…、ボットのメッセージを…、よ、読み上げます!",
        ...
        "reademoji_F": "こ、これからは…、絵文字を…、よ、読み上げません!",
        "reademoji_T": "こ、これからは…、絵文字を…、よ、読み上げます!",
        "userjoin_F": "こ、これからは…、ボイスチャットで起きた…、出来事を…、よ、読み上げません!",
        "userjoin_T": "こ、これからは…、ボイスチャットで起きた…、出来事を…、よ、読み上げます!",
        "blacklist": "こ、これからは…、登録したユーザーやロールを…、ブラックリストとして…、と、取り扱います!",
        "whitelist": "こ、これからは…、登録したユーザーやロールを…、ホワイトリストとして…、と、取り扱います!",
        "readoutsideusers_F": "こ、これからは…、ボイスチャットにいない…、ユーザーのメッセージを…、よ、読み上げません!",
        "readoutsideusers_T": "こ、これからは…、ボイスチャットにいない…、ユーザーのメッセージを…、よ、読み上げます!",
        "forcejapanese_T": "こ、これからは…、日本語のボイスだけで…、よ、読み上げます!",
        "forcejapanese_F": "こ、これからは…、日本語のボイスだけで…、よ、読み上げません!",
        "afktimeout_F": "こ、これからは…、私がボイチャから…、自動で抜け…、ません!",
        "afktimeout_T": f"こ、これからは、私が{input1}分、{input2}秒、話さなかった時に、勝手に…、抜けます!",
        ...
        "hello": "あ、こ、こんにちはです!わ、私は…、ベルーガの、る、ルカです!こ、これからの文章を、読み上げます!よ、よろしく…、お願いします!",
        ...
        "noprivateerror": "こ、ここはDMです!こ、このコマンドは、ここでは使えません!",
